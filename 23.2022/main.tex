...
\end{align}
From \eqref{eq:2} and \figref{fig:11}, $|H(f)|$ is same.But from \eqref{eq:7}, $\angle H(f)$ is directly propotional to frequency and time delay. The system will acts as pure delay sytem. Now, if we take $f^2$ as frequency, the system doesn't act as pure delay system.\\
