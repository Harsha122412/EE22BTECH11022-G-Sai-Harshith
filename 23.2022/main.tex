...
\angle H(f)&=2\pi fT_d
\end{align}
Here, $\angle H(f)$ is directly propotional to frequency and time delay. The system will acts as pure delay sytem. Now, if we take $f^2$ as frequency, the system doesn't act as pure delay syatem because $\angle H(f)$ is propotional to $f^2$ but not $f$.\\
