...
def parametric_form (A,B,k):
    ...
    return x
def unit_vec(A,B):
	return ((dir_vec(A,B))/np.linalg.norm(dir_vec(A,B)))
...
print("The direction vector of AB is ",dir_vec(A,B))
print("The direction vector of BC is ",dir_vec(B,C))
print("The direction vector of CA is ",dir_vec(C,A))

print("The solution to the question 1.1.2:")
length_BC = np.linalg.norm(dir_vec(B,C))
...
plt.savefig('RandomVectors/figs/Q1.1.3.png')
plt.show()
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('RandomVectors/figs/Q1.2.2.png')
plt.show()
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('RandomVectors/figs/Q1.3.4.png')
plt.show()
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('RandomVectors/figs/Q1.5.1.png')
plt.show()
...
plt.grid() 
plt.axis('equal')
plt.savefig('RandomVectors/figs/Q1.4.5.png')
plt.show()
...
plt.savefig('RandomVectors/figs/Q1.5.7.png')
plt.show()
