...
\hhline{|---|}
	...
	% \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 {\gnumericPB{\raggedright}\gnumbox[l]{Normal vector of $AB$}}
\\
\hhline{|---|}
	\multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\norm{\vec{B}-\vec{A}}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$6.083$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|}
	...
	% \addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	% \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 {\gnumericPB{\raggedright}\gnumbox[l]{Normal vector of $BC$}}	
\\
\hhline{|---|}
	\multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\norm{\vec{C}-\vec{B}}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$6.325$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|}
	...
	% \addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	% \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	 {\gnumericPB{\raggedright}\gnumbox[l]{Normal vector of $CA$}}
\\	
\hhline{|---|}
	\multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\norm{\vec{A}-\vec{C}}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$6.403$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{62.10}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	%{\setlength{\gnumericMultiRowLength}{0pt}%
	% \addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	% \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{57.10}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	 {angle between $CB$ and $CA$}
\\
\hhline{|-|-|-|}
%\end{longtable}
\end{tabular}
