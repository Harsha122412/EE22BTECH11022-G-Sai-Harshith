...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\myvec{-1 \\ \frac{-3}{2}}$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	 %{\setlength{\gnumericMultiRowLength}{0pt}%
	 %\addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	 %\multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\myvec{0 \\ \frac{3}{2}}$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	 %{\setlength{\gnumericMultiRowLength}{0pt}%
	 %\addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	 %\multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\myvec{\frac{-7}{2} & 4}$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	%{\setlength{\gnumericMultiRowLength}{0pt}%
	% \addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	% \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\myvec{\frac{11}{2} & 1}$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	%{\setlength{\gnumericMultiRowLength}{0pt}%
	% \addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	% \multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\myvec{\frac{1}{3}\\\frac{-1}{3}}$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{Centroid of the triangle}}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$\frac{AG}{DG}=\frac{BG}{EG}=\frac{CG}{FG}$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	 ...
	 %\addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	 %\multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	{\gnumericPB{\centering}\gnumbox{$\vec{G}$ divides median in ratio 2:1}}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	 ...
	 %\addtolength{\gnumericMultiRowLength}{\gnumericColC}%
	 %\multirow{2}[1]{\gnumericMultiRowLength}{\parbox{\gnumericMultiRowLength}{%
	{\gnumericPB{\centering}\gnumbox{Points are collinear}}
\\	
\hhline{|-|-|-|}
%\end{longtable}
\end{tabular}
